...
const PART_CATEGORIES: PartCategory[] = [
  ...
  // ─────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: "throw_folded_cream", label: "Folded Cream Throw", icon: "☰", description: "Neatly folded blanket", shape: "rounded_rect", type: "horizontal", size: [0.50, 0.015, 0.35], materialId: "fabric_cream", placeOnFloor: true, shapeParams: { cornerRadius: 0.005 } },
      { id: "throw_folded_gray", label: "Folded Gray Throw", icon: "☰", description: "Neatly folded blanket", shape: "rounded_rect", type: "horizontal", size: [0.50, 0.015, 0.35], materialId: "fabric_gray", placeOnFloor: true, shapeParams: { cornerRadius: 0.005 } },
      { id: "throw_folded_charcoal", label: "Folded Charcoal Throw", icon: "☰", description: "Neatly folded blanket", shape: "rounded_rect", type: "horizontal", size: [0.50, 0.015, 0.35], materialId: "fabric_charcoal", placeOnFloor: true, shapeParams: { cornerRadius: 0.005 } },
      { id: "throw_folded_taupe", label: "Folded Taupe Throw", icon: "☰", description: "Neatly folded blanket", shape: "rounded_rect", type: "horizontal", size: [0.50, 0.015, 0.35], materialId: "fabric_taupe", placeOnFloor: true, shapeParams: { cornerRadius: 0.005 } },
      // Draped throws — thin flat panels
      { id: "throw_draped_cream", label: "Draped Cream Throw", icon: "≈", description: "Casually draped blanket", shape: "rounded_rect", type: "horizontal", size: [0.80, 0.01, 0.60], materialId: "fabric_cream", placeOnFloor: true, shapeParams: { cornerRadius: 0.005 } },
      { id: "throw_draped_gray", label: "Draped Gray Throw", icon: "≈", description: "Casually draped blanket", shape: "rounded_rect", type: "horizontal", size: [0.80, 0.01, 0.60], materialId: "fabric_gray", placeOnFloor: true, shapeParams: { cornerRadius: 0.005 } },

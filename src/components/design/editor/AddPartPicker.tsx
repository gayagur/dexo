...
const PART_CATEGORIES: PartCategory[] = [
  ...
  // ─────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "☰",
        description: "Neatly folded throw blanket",
        shape: "cushion_firm",
        type: "horizontal",
        size: [0.50, 0.06, 0.35],
        materialId: "fabric_charcoal",
      ...
      },
      {
        ...
        label: "Draped throw",
        icon: "≈",
        description: "Casually draped blanket",
        shape: "cushion_firm",
        type: "horizontal",
        size: [0.80, 0.04, 0.60],
        materialId: "fabric_taupe",
      ...
      },
      {
        ...
        icon: "▓",
        description: "Thick bed comforter",
        shape: "cushion",
        type: "horizontal",
        size: [1.50, 0.18, 1.90],
        materialId: "fabric_charcoal",
  ...
  // ─────────────────────────────────────────────────
  {
    ...
    icon: "🧶",
    items: [
      { id: "throw_folded_cream", label: "Folded Cream Throw", icon: "☰", description: "Neatly folded blanket", shape: "cushion_firm", type: "horizontal", size: [0.50, 0.06, 0.35], materialId: "fabric_cream", placeOnFloor: true },
      { id: "throw_folded_gray", label: "Folded Gray Throw", icon: "☰", description: "Neatly folded blanket", shape: "cushion_firm", type: "horizontal", size: [0.50, 0.06, 0.35], materialId: "fabric_gray", placeOnFloor: true },
      { id: "throw_folded_charcoal", label: "Folded Charcoal Throw", icon: "☰", description: "Neatly folded blanket", shape: "cushion_firm", type: "horizontal", size: [0.50, 0.06, 0.35], materialId: "fabric_charcoal", placeOnFloor: true },
      { id: "throw_folded_taupe", label: "Folded Taupe Throw", icon: "☰", description: "Neatly folded blanket", shape: "cushion_firm", type: "horizontal", size: [0.50, 0.06, 0.35], materialId: "fabric_taupe", placeOnFloor: true },
      { id: "throw_draped_cream", label: "Draped Cream Throw", icon: "≈", description: "Casually draped blanket", shape: "cushion_firm", type: "horizontal", size: [0.80, 0.04, 0.60], materialId: "fabric_cream", placeOnFloor: true },
      { id: "throw_draped_gray", label: "Draped Gray Throw", icon: "≈", description: "Casually draped blanket", shape: "cushion_firm", type: "horizontal", size: [0.80, 0.04, 0.60], materialId: "fabric_gray", placeOnFloor: true },
      { id: "duvet_white", label: "White Duvet", icon: "▓", description: "Thick bed comforter", shape: "cushion", type: "horizontal", size: [1.50, 0.18, 1.90], materialId: "fabric_cream", placeOnFloor: true },
      { id: "duvet_charcoal", label: "Charcoal Duvet", icon: "▓", description: "Dark bed comforter", shape: "cushion", type: "horizontal", size: [1.50, 0.18, 1.90], materialId: "fabric_charcoal", placeOnFloor: true },
      { id: "duvet_brown", label: "Brown Duvet", icon: "▓", description: "Brown bed comforter", shape: "cushion", type: "horizontal", size: [1.50, 0.18, 1.90], materialId: "fabric_brown", placeOnFloor: true },
      { id: "bed_runner_brown", label: "Brown Bed Runner", icon: "━", description: "Decorative bed strip", shape: "cushion_firm", type: "horizontal", size: [1.50, 0.03, 0.50], materialId: "fabric_brown", placeOnFloor: true },
      { id: "bed_runner_gray", label: "Gray Bed Runner", icon: "━", description: "Decorative bed strip", shape: "cushion_firm", type: "horizontal", size: [1.50, 0.03, 0.50], materialId: "fabric_gray", placeOnFloor: true },
    ],
  },
